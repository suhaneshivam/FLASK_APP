...
def register():
    ...
    if form.validate_on_submit():
        ...
        db.session.add(user)
        db.session.commit()
        flash(f'Your account has been created successfully.Now you are able to log in !','success')
...
def reset_token(token):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash(f'Your Password has been Update successfully.Now you are able to log in !','success')
        return redirect(url_for('users.login'))
